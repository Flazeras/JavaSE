...
public class MyClass {
    ...
    public void printInfo() {
        ...
        try {
            System.out.println("MyClass print method: " + getClass().getMethod("print"));
            System.out.println("MyClass print method myAnno annotation: " + getClass().getMethod("print").getAnnotation(MyAnno.class));
